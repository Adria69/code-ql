...
async function loadConfig(languagesInput, rawQueriesInput, rawPacksInput, configFile, dbLocation, debugMode, debugArtifactName, debugDatabaseName, repository, tempDir, toolCacheDir, codeQL, workspacePath, gitHubVersion, apiDetails, featureFlags, logger) {
    ...
    const queriesInput = ((queriesInputCombines
        ? rawQueriesInput === null || rawQueriesInput === void 0 ? void 0 : rawQueriesInput.slice(1).split(",")
        : rawQueriesInput === null || rawQueriesInput === void 0 ? void 0 : rawQueriesInput.split(",")) || []).map((query) => ({ uses: query })) || [];
    const packs = parsePacks((_a = parsedYAML[PACKS_PROPERTY]) !== null && _a !== void 0 ? _a : {}, packsInput, packsInputCombines, languages, configFile);
    ...
    let injectedMlQueries = false;
    if (rawQueriesInput) {
        injectedMlQueries = await addQueriesAndPacksFromWorkflow(codeQL, rawQueriesInput, languages, queries, packs, tempDir, workspacePath, apiDetails, featureFlags, logger);
    }
    ...
    return {
        ...
        augmentationProperties: {
            injectedMlQueries,
            packsInputCombines,
            packsInput: (_b = packsInput === null || packsInput === void 0 ? void 0 : packsInput[languages[0]]) !== null && _b !== void 0 ? _b : [],
...
function parsePacksFromInput(rawPacksInput, languages) {
...
// exported for testing
function parsePacks(rawPacksFromConfig, packsFromInput, packsInputOverrides, languages, configFile) {
