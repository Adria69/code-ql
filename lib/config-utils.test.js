...
function parseInputAndConfigMacro(t, packsFromConfig, packsFromInput, languages, expected) {
    t.deepEqual(configUtils.parsePacks(packsFromConfig, packsFromInput === null || packsFromInput === void 0 ? void 0 : packsFromInput.split(","), false, languages, "/a/b"), expected);
}
...
function parseInputAndConfigErrorMacro(t, packsFromConfig, packsFromInput, languages, expected) {
    t.throws(() => {
        configUtils.parsePacks(packsFromConfig, packsFromInput === null || packsFromInput === void 0 ? void 0 : packsFromInput.split(","), false, languages, "/a/b");
    }, {
        message: expected,
    });
}
